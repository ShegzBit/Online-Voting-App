                ...
                <div className="row justify-content-center">
                    <div className='col-lg-6 col-md-6 col-sm-12'>
                        ...
                        <div className="d-grid gap-2">
                            ...
                            <p className="mt-3 text-center">Already have an account? <a href="https://pollmaster.me/signin" className=" fw-semibold link-success link-offset-2 link-underline link-underline-opacity-0">Log in here </a></p>
                        </div>
                    </div>
                </div>
            </div>
