...
const createElection = async (data) => {
    try {
        const res = await axios.post('https://api.pollmaster.me/api/v1/create_election', data)
        return res.data
    } catch (e) {
        console.log(e)
        throw Error(e)
...
const updateElection = async (admin_id, election_id, data) => {
    try {
        const res = await axios.put(`https://api.pollmaster.me/admin/${admin_id}/election/${election_id}`, data)
        return res.data
    } catch (e) {
        console.log(e)
        throw Error(e)
