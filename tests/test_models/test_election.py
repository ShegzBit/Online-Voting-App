...
class TestElection(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.election.candidates, ["Candidate 1", "Candidate 2"])
    ...
    def test_init_start_date_validation(self):
        ...
        with self.assertRaises(ValueError) as cm:
            E3 = Election("Test", "test_time", 
                          (datetime.now() + timedelta(days=2)).strftime('%Y-%m-%d %H:%M:%S'), 
                          ["Candidate 1", "Candidate 2"])
        self.assertEqual(str(cm.exception), "Invalid date format. Use 'YYYY-MM-DD HH:MM:SS'")
    ...
    def test_init_start_date_empty(self):
        ...
        with self.assertRaises(ValueError) as cm:
            Election("Test Election", 
                    ...
                    (datetime.now() + timedelta(days=2)).strftime('%Y-%m-%d %H:%M:%S'), 
                    ["Candidate 1", "Candidate 2"])
        self.assertEqual(str(cm.exception), "Election starting date is required in the format 'YYYY-MM-DD HH:MM:SS'")
    ...
    def test_init_end_date_empty(self):
        ...
        with self.assertRaises(ValueError) as cm:
            Election("Test Election", 
                    ...
                    "", 
                    ["Candidate 1", "Candidate 2"])
        self.assertEqual(str(cm.exception), "Election ending date is required in the format 'YYYY-MM-DD HH:MM:SS'")
    ...
    def test_init_start_date_after_end_date(self):
        ...
        with self.assertRaises(ValueError) as cm:
            Election("Test Election", 
                    ...
                    (datetime.now() + timedelta(days=1)).strftime('%Y-%m-%d %H:%M:%S'), 
                    ["Candidate 1", "Candidate 2"])
        self.assertEqual(str(cm.exception), "Election starting date must be before the ending date")
    ...
    def test_init_candidates_not_strings(self):
        ...
        with self.assertRaises(TypeError) as cm:
            Election("Test Election", 
                    ...
                    (datetime.now() + timedelta(days=2)).strftime('%Y-%m-%d %H:%M:%S'), 
                    [1, 2, 3])
        self.assertEqual(str(cm.exception), "Candidates' list must contain strings only")
    ...
    def test_add_voter(self):
        ...
        self.assertIn({"first_name": "John", "last_name": "Doe", "email": "john.doe@example.com"}, self.election.voters)

    def test_make_ballot(self):
        self.election.make_ballot("Ballot 1", ["Candidate 1", "Candidate 3"])
        self.assertIn({"name": "Ballot 1", "candidates": ["Candidate 1", "Candidate 3"]}, self.election.ballots)
