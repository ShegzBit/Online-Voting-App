...
class TestAdminModel(unittest.TestCase):
    def setUp(self):
        ...
        self.admin = Admin(firstname='Test', lastname='User', username='testuser', email='test@example.com', password='password')

    def test_new_election(self):
        """Test the new_election method"""
        election = self.admin.new_election(firstname='Election', lastname='Test', email='election@example.com', password='password')
    ...
    def test_update_election(self):
        ...
        election = self.admin.new_election(firstname='Election', lastname='Test', email='election@example.com', password='password')
        updated_election = self.admin.update_election(election.id, firstname='Updated', lastname='Election')
